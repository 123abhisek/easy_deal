              ...
              children: [
                  ...
                  child: hasImage
                      ? CachedNetworkImage(
                          ...
                          errorWidget: (_, __, ___) => Container(
                            ...
                            child: const Icon(Icons.directions_car_rounded, size: 48, color: Colors.grey),
                          ),
                        )
                      : Container(
                          color: AppColors.vehicleAccentLight,
                          child: const Icon(Icons.directions_car_rounded, size: 48, color: AppColors.vehicleAccent),
                        ),
                ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      '${vehicle.year} • ${vehicle.fuelType ?? 'Petrol'}',
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text(
                      CurrencyHelper.formatCompact(vehicle.expectedPrice),
                      style: const TextStyle(
                        color: Colors.white,
                        fontSize: 12,
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.location_on_outlined, size: 14, color: AppColors.vehicleAccent),
                  ...
                  // Specs Row (KM, Transmission, Owners)
                  Row(
                    children: [
                      if (vehicle.kmDriven != null) ...[
                        _buildSpecItem(Icons.speed_rounded, '${vehicle.kmDriven} km'),
                        const SizedBox(width: 14),
                      ],
                      if (vehicle.transmission != null) ...[
                        _buildSpecItem(Icons.tune_rounded, vehicle.transmission!),
                        const SizedBox(width: 14),
                      ],
                      if (vehicle.ownerCount != null) ...[
                        _buildSpecItem(Icons.person_pin_circle_outlined, vehicle.ownerCount!),
                      ],
                    ],
                  ),
